...
class DespesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create despesa" do
    assert_difference('Despesa.count') do
      post despesas_url, params: { despesa: { nome: @despesa.nome, tipo: @despesa.tipo, user_id: @despesa.user_id } }
    end
  ...
  test "should update despesa" do
    patch despesa_url(@despesa), params: { despesa: { nome: @despesa.nome, tipo: @despesa.tipo, user_id: @despesa.user_id } }
